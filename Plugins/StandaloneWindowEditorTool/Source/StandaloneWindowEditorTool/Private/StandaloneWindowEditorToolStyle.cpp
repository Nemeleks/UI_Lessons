...
TSharedPtr< FSlateStyleSet > FStandaloneWindowEditorToolStyle::StyleInstance = NULL;

void FStandaloneWindowEditorToolStyle::Initialize()
{
...
void FStandaloneWindowEditorToolStyle::Shutdown()
{
...
FName FStandaloneWindowEditorToolStyle::GetStyleSetName()
{
	static FName StyleSetName(TEXT("StandaloneWindowEditorToolStyle"));
	return StyleSetName;
}
...
void FStandaloneWindowEditorToolStyle::ReloadTextures()
{
...
const ISlateStyle& FStandaloneWindowEditorToolStyle::Get()
{
